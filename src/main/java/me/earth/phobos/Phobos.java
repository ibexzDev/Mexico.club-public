...
public class Phobos {
    ...
    public static final Logger LOGGER = LogManager.getLogger("Mexico.club");
    ...
    public static void load() {
        ...
        LOGGER.info("Mexico.club initialized!\n");
    }

    public static void unload(boolean unload) {
        LOGGER.info("\n\nUnloading Mexico.club 1.0.0");
        if (unload) {
        ...
        safetyManager = null;
        LOGGER.info("Mexico.club unloaded!\n");
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        LOGGER.info("AlphaArmor is cute!!!");
        LOGGER.info("faggot above - BetaCalculator");
        LOGGER.info("PuggersKEK wins again");
        LOGGER.info("gtfo my logs - BetaMC");
    }

    @Mod.EventHandler
    public void init(FMLInitializationEvent event) {
        customMainScreen = new GuiCustomMainScreen();
        Display.setTitle("Mexico.club - v.1.0.0");
        Phobos.load();
    }
}
